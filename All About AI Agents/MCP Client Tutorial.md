Building a LLM-powered chatbot client that connects to MCP servers.

```
uv init <client-project-name>
cd <client-project-name>
uv venv # create virtual environment
source .venv/bin/activate # activate virtual env

uv add mcp anthropic python-dotenv# install required packages
