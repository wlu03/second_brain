...
def grid_distance(x1: int, y1: int, x2: int, y2: int) -> float:
    ...
    # TODO: implement here
    # ----------------------------------
    dist = float(math.sqrt((y2-y1)**2 + (x2-x1)**2))
    # ----------------------------------
    return dist
...
def rotate_point(x: float, y: float, heading_deg: float) -> Tuple:
    ...
    # convert the heading_deg to radian, pi/180
    ...
    # TODO: implement here
    # ----------------------------------
    heading_rads = heading_deg * (math.pi / 180)
    xr = x*math.cos(heading_rads) - y*math.sin(heading_rads)
    yr = y*math.cos(heading_rads) + x*math.sin(heading_rads)
