...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GFG obj = new GFG();
        int V = 10; // Since J maps to 10, which is the highest index.
        List<List<Integer>> edges = new ArrayList<>();
        edges.add(new ArrayList<>(List.of(1, 2)));
        edges.add(new ArrayList<>(List.of(2, 3)));
        edges.add(new ArrayList<>(List.of(2, 6)));
        edges.add(new ArrayList<>(List.of(2, 9)));
        edges.add(new ArrayList<>(List.of(3, 6)));
        edges.add(new ArrayList<>(List.of(3, 4)));
        edges.add(new ArrayList<>(List.of(4, 5)));
        edges.add(new ArrayList<>(List.of(5, 3)));
        edges.add(new ArrayList<>(List.of(5, 8)));
        edges.add(new ArrayList<>(List.of(6, 7)));
        edges.add(new ArrayList<>(List.of(7, 10)));
        edges.add(new ArrayList<>(List.of(8, 7)));
        edges.add(new ArrayList<>(List.of(9, 6)));
        edges.add(new ArrayList<>(List.of(9, 1)));
        edges.add(new ArrayList<>(List.of(9, 7)));
        edges.add(new ArrayList<>(List.of(10, 8)));
